...
%>
                <table class="max-w-2xl mx-auto mt-20">
<%
...
%>
                <tr>
                	<td><%=i+1%>&nbsp;&nbsp;</td><td><font color="blue"><b><a href=<%=doc.get("url")%>><%=doctitle%></a></b></font></td>
                </tr>
                <tr>
		        	<td></td><td class="max-w-md lg:max-w-xl truncate ..."><a href=<%=doc.get("url")%> style="color:green;text-decoration: none;"><%=doc.get("url")%></a></td>
                </tr>
                <tr>
		        	<td></td><td class="max-w-md lg:max-w-xl truncate ..."><%=doc.get("contents")%></td>
                </tr>
                	<tr><td>&nbsp;</td><td></td>
                </tr>
<%
...
%>
                <tr>
                        <td></td><td><a href="<%=moreurl%>"><button class="transition duration-300 hover:bg-gray-200 py-2 bg-gray-100 px-4 rounded-sm">More Results ></button></a></td>
                </tr>
<%
                }
%>
